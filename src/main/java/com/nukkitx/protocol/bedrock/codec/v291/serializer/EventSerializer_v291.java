...
import com.nukkitx.protocol.bedrock.data.event.AgentResult;
...
public class EventSerializer_v291 implements BedrockPacketSerializer<EventPacket> {
   ...
   protected EventSerializer_v291() {
      ...
      this.readers.put(EventDataType.AGENT_CREATED, (BiFunction)(buf, helper) -> AgentCreatedEventData.INSTANCE);
      ...
      this.writers.put(EventDataType.AGENT_CREATED, (TriConsumer)(buf, helper, data) -> {
      });
   ...
   public void serialize(ByteBuf buffer, BedrockCodecHelper helper, EventPacket packet) {
      ...
      TriConsumer<ByteBuf, BedrockCodecHelper, EventData> function = (TriConsumer)this.writers.get(eventData.getType());
      if (function == null) {
   ...
   public void deserialize(ByteBuf buffer, BedrockCodecHelper helper, EventPacket packet) {
      ...
      BiFunction<ByteBuf, BedrockCodecHelper, EventData> function = (BiFunction)this.readers.get(type);
      if (function == null) {
