...
import com.nukkitx.protocol.common.PacketHandler;
...
public interface BedrockPacketHandler extends PacketHandler {
   ...
   default PacketSignal handle(NetworkGamePacket packet) {
      return PacketSignal.UNHANDLED;
   }

   default PacketSignal handle(NeteaseNetGameTransferPacket packet) {
      return PacketSignal.UNHANDLED;
   }

   default PacketSignal handle(NeteaseNetGameTransferBatchPacket packet) {
      return PacketSignal.UNHANDLED;
   }
