...
public enum HAProxyProxiedProtocol implements ProxyProtocolConstants {
   ...
   // $FF: synthetic method
   private static HAProxyProxiedProtocol[] $values() {
      return new HAProxyProxiedProtocol[]{UNKNOWN, TCP4, TCP6, UDP4, UDP6, UNIX_STREAM, UNIX_DGRAM};
   }
   ...
   public static enum AddressFamily {
      ...
      // $FF: synthetic method
      private static AddressFamily[] $values() {
         return new AddressFamily[]{AF_UNSPEC, AF_IPv4, AF_IPv6, AF_UNIX};
      }
   }
   ...
   public static enum TransportProtocol {
      ...
      // $FF: synthetic method
      private static TransportProtocol[] $values() {
         return new TransportProtocol[]{UNSPEC, STREAM, DGRAM};
      }
   }
}
